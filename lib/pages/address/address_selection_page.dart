...
class _AddressSelectionPageState extends State<AddressSelectionPage> {
  ...
  void _initializeDeliveryType() {
    final storeConfig =
        context.read<StoreCubit>().state.store?.store_operation_config;
    ...
    } else if (currentType == DeliveryType.pickup &&
        !pickupEnabled &&
        deliveryEnabled) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: AddressCheckoutSelectionStep(
        ...
        onAddressTap:
            _onAddressTap, // ✅ Conecta o callback de validação imediata
